      ...
      <div className="hero-container">
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
          ...
          <div className="lg:w-1/2 h-full flex justify-center lg:justify-end items-center">
            <div 
              ref={imageRef}
              className="relative transition-all duration-700 ease-out opacity-0 translate-x-10"
            >
              ...
              <img
                ...
                alt="Omollo Victor"
                className="relative w-full max-w-md rounded-2xl bg-purple-400 shadow-xl z-10"
              />
            </div>
          </div>
        </div>
